...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 18 2020 г., 12:46
...
(3, 'Строительство и эксплуатация здании и сооружении', 3, 1),
...
ALTER TABLE `gruppa`
  ...
  ADD KEY `name` (`name`,`special_id`,`date_begin`),
...
ALTER TABLE `lesson_plan`
  ...
  ADD KEY `gruppa_id` (`gruppa_id`,`subject_id`,`user_id`),
...
ALTER TABLE `role`
  ...
  ADD KEY `sys_name` (`sys_name`,`name`);
...
ALTER TABLE `schedule`
  ...
  ADD KEY `lesson_plan_id` (`lesson_plan_id`,`day_id`,`lesson_num_id`,`classroom_id`),
...
ALTER TABLE `student`
  ...
  ADD KEY `gruppa_id` (`gruppa_id`,`num_zach`);
...
ALTER TABLE `subject`
  ...
  ADD KEY `name` (`name`,`otdel_id`,`hours`),
  ADD KEY `otdel_id` (`otdel_id`);
...
ALTER TABLE `user`
  ...
  ADD KEY `lastname` (`lastname`,`firstname`,`role_id`),
...
ALTER TABLE `schedule`
  ...
  ADD CONSTRAINT `schedule_ibfk_2` FOREIGN KEY (`lesson_num_id`) REFERENCES `lesson_num` (`lesson_num_id`),
  ADD CONSTRAINT `schedule_ibfk_3` FOREIGN KEY (`day_id`) REFERENCES `day` (`day_id`),
